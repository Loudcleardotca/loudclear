			...
			<div id="contents">
				...
				<div id="swiper-content">
					<div class="swiper-wrapper">
						...
						####################################
						-->
						<div id ="home" class="sub-page swiper-slide" data-hash="welcome" >
                        <!-- Kenburn Slider -->
								<div id="kb-container">
								</div>
                        <!-- Next page shortcut -->
						...
						#################################
						-->
						<div class="sub-page swiper-slide" data-hash="about-us">
						...
						-->
						<!-- ####### STAN - 2 ####### -->
						<div class="sub-page swiper-slide" data-hash="stan-difruscio">
							...
							<!-- ####### CHRIS - 3 ####### -->
							<div class="sub-page swiper-slide" data-hash="chris-robertson ">
							...
							<!-- ####### ERIN - 4 ####### -->
							<div class="sub-page swiper-slide" data-hash="erin-mitchell">
							<!-- Page contents -->
							<div class="page-container" style="width:100%;" id="partners">
								<div class="inner-wrapper scrollbar">
							...
							<div class="page-container" style="width:100%;">
								<div class="inner-wrapper">
                                    ...
                                    <div id="fullpage">    
                                        ...
                                        <!-- ################################# SECTION 1 ################################# -->
									  	<div class="section" id="section1" data-anchor="services" style="padding-bottom:20px;">
...
font-weight: bold; "><?php the_field('second_title', 'option'); ?></span></h2>
				...
				<div id="taskbar">
					...
					<a href="javascript:void(0);" class="menu-link" onclick="javascript:mobileFunction();"></a>
...
<!--
	...
	$(document).ready(function() {
		...
		if (!isTouchDevice){
			...
			//$('#teamDetail').removeClass('centerit');
	...
	$(document).ready(function() {
		...
		$('#vfb-7').attr("placeholder", "Message");
