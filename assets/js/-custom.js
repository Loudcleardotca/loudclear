...
var ms,menuPannel = {
  ...
  settings: {
    ...
    //#taskbarmenuImageContainer : $("#menu-pannel-image").find(".hex-3"),
  ...
  moveNavMenu:function(index){
    var $container = ms.menuSliderContainer,
        ...
        activeIndex = $('#menu-pannel-navigation .active').index();
  ...
  prepare : function(){
    ...
    ms.menuThumbs.each(function(){
      ...
      ms.menuPannelNavs.append('<li class="item"></li>').children().first().addClass('active');
    });
...
var ups, upstreamPortfolio = {
  ...
  bindUIActions: function(){
    ...
    ups.portfolioTrigger.on('click',function(event){
...
$gmap.gmap3({
  ...
  overlay:{
    ...
    address: "20 Court St, St Catharines, ON L2R",
    options:{
